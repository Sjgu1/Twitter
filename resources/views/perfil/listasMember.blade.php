                    ...
                    u-lg-size2of3" data-test-selector="ProfileTimeline">
                        <div class="ProfileHeading">
                            ...
                            <div class="ProfileHeading-content">
                                ...
                                <ul class="ProfileHeading-toggle">
                                    <li class="ProfileHeading-toggleItem  u-textUserColor" data-element-term="subscribed_to_toggle">
                                        <a class="ProfileHeading-toggleLink js-nav" href="/{{$user->username}}/listas" data-nav="subscribed_to_toggle">
                                    Suscrito a
                                    </a>
                                    </li>
                                    <li class="ProfileHeading-toggleItem  is-active" data-element-term="member_of_toggle">
                                        <span aria-hidden="true">Miembro de</span>
                                        <span class="u-hiddenVisually">Miembro de, página actual.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="ProfileListsTimeline">
                            <div class="GridTimeline">
                                ...
                                @if($user->miembro->count()==0)
                                <div class="GridTimeline-items" role="list" data-max-position="" data-min-position=""></div>
                                <div class="GridTimeline-end">
                                    <div class="GridTimeline-emptyText" id="content-main-heading">
                                        Parece que nadie te ha añadido a una lista, aún. Tal vez algún día.
                                    </div>
                                ...
                                @foreach($memberships as $member)
                                    <div class="Grid" role="presentation">
                                        <div class="Grid-cell js-stream-item" data-test-selector="ProfileTimelineList" role="listitem" data-item-id="934488406817755136" id="stream-item-list-934488406817755136" data-item-type="list">
                                            <div class="ProfileListItem u-cf js-list " data-user-id="293967812" data-list-id="934488406817755136">
                                                <a class="ProfileListItem-name js-list-link js-nav u-dir" dir="ltr" href="/{{$member->usuario->username}}/listas/{{$member->nombre}}">{{$member->nombre}}</a>
                                                <a class="ProfileListItem-avatarLink u-textUserColor u-floatRight" href="/{{$member->usuario->username}}" tabindex="-1" aria-hidden="true">
                                                    <img class="ProfileListItem-avatar" src="{{$member->usuario->avatar}}" alt="">
                                                    </a>
                                                    <span class="ProfileListItem-byLine">por 
                                                        <a class="ProfileListItem-ownerName" href="/ferelcete">Ferel</a>
                                                    </span>
                                                    <p class="ProfileListItem-bio u-dir" dir="ltr"></p>
                                                    <div class="ProfileListItem-footer">
                                                        <p class="ProfileListItem-memberCount">{{$member->miembros->count()}} miembros</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
