...
<body class="three-col logged-in user-style-username western es enhanced-mini-profile no-nav-banners supports-drag-and-drop" data-fouc-class-names="swift-loading no-nav-banners" dir="ltr">
                    ...
                    <!-- Parte izquierda, barra de navegacion -->
                        <div role="navigation" style="display: inline-block;">
                            <ul class="nav js-global-actions" id="global-actions">
                                ...
                                <!-- Icono Mensajes-->
                                <li class="dm-nav">
                                    <a role="button" href="#" class="js-tooltip js-dynamic-tooltip global-dm-nav" data-placement="bottom" data-original-title="" data-toggle="modal" data-target="#dm_dialog-dialog">
    ...
    <div class=" modal-body">
        ...
        <form action="//upload.twitter.com/i/tweet/create_with_media.iframe" class="t1-form tweet-form pull-right" data-condensed-text="¿Qué está pasando?" data-poll-composer-rows="3" enctype="multipart/form-data" id="swift_tweetbox_1515235399021" method="post" name="swift_tweetbox_1515235399021" target="tweet-post-iframe" style="width: 508px;">
                    ...
                    <div class="RichEditor-container u-borderRadiusInherit">
                        ...
                        <div class="RichEditor-scrollContainer u-borderRadiusInherit">
                            <div aria-autocomplete="list" aria-expanded="false" aria-labelledby="tweet-box-home-timeline-label" aria-multiline="true" aria-owns="typeahead-dropdown-3" class="tweet-box rich-editor is-showPlaceholder" contenteditable="true" data-placeholder-default="¿Qué está pasando?"
                                data-placeholder-poll-composer-on="Haz una pregunta..." data-placeholder-reply="Twittea tu respuesta" dir="ltr" id="tweet-box-home-timeline" name="tweet" role="textbox" spellcheck="true">
                                <div><br></div>
                            </div>
                            <div aria-hidden="true" class="RichEditor-pictographs"></div>
                        </div>
            ...
            <div class="TweetBoxToolbar-tweetButton tweet-button">
                ...
                </span> <button class="tweet-action EdgeButton EdgeButton--primary js-tweet-btn disabled" disabled="" type="button"><span class="button-text tweeting-text">Twittear</span> <span class="button-text replying-text">Responder</span></button>
            </div>
    </div>
    <div style="position: absolute; visibility: hidden;"></div>
    <div style="position: absolute; visibility: hidden;">
    ...
    <div style="position: absolute; visibility: hidden;">
        ...
        <div class="modal-overlay" style="z-index: 4001;"></div>
    <!-- modal mensajes-->
    <div id="dm_dialog" class=" DMDialog modal-container" style="z-index: 4002;">
  <div class=" modal fade modal-content modal is-autoPosition" id="dm_dialog-dialog" role="dialog" aria-labelledby="dm_dialog-header"><div class="js-first-tabstop" tabindex="0" style="z-index: 6502;"></div>
    <div class="DMActivity DMInbox js-ariaDocument u-chromeOverflowFix" role="document">
  ...
  <ul class="TokenizedMultiselect-inputContainer">
    <li>
      <textarea class="TokenizedMultiselect-input twttr-directmessage-input js-initial-focus dm-to-input" aria-autocomplete="list" aria-expanded="true" rows="1" type="text" placeholder="Ingresa un nombre" aria-owns="TokenizedMultiselectOwns250787641"></textarea>
    </li>
  </ul>
    ...
    <div class="DMActivity-footer u-emptyHide">    
      ...
      <div class="DMDock-conversations">
        <div class="DMConversationContainer">
          <div class="DMActivity DMConversation js-ariaDocument u-chromeOverflowFix DMActivity--open" role="document" data-thread-id="112817801-301028364">
            <div class="DMActivity-header">
                <div class="DMActivity-navigation">
                    <button type="button" class="DMActivity-back u-textUserColorHover" to-inbox="">
                    <span class="Icon Icon--caretLeft u-linkComplex-target Icon--medium"></span>
...
<div class="DMPopover DMPopover--center">
  <button class="DMPopover-button" aria-haspopup="true" disabled="">
      ...
      <div class="DMUpdateAvatar-avatar"><a href="/belenperez95" class="js-action-profile js-user-profile-link" data-user-id="112817801">
  <div class="DMAvatar DMAvatar--1 u-chromeOverflowFix">
    <span class="DMAvatar-container">
      <img class="DMAvatar-image" src="https://pbs.twimg.com/profile_images/575079279366701056/UwEzLCK__200x200.jpeg" alt="!" title="!">
    </span>
</div>
  ...
  <div class="DMNotice-actions u-emptyHide">    <button type="button" class="DMDeleteMessage-cancel EdgeButton EdgeButton--tertiary">Cancelar</button>
  ...
  <div class="DMNotice-message">    Se eliminará el mensaje de tu vista de conversaciones.
</div>
  <div class="DMNotice-actions u-emptyHide">    <button type="button" class="DMReportMessage-cancel EdgeButton EdgeButton--tertiary">Cancelar</button>
    <button type="button" class="DMReportMessage-spam EdgeButton EdgeButton--secondary">Es spam</button>
    <button type="button" class="DMReportMessage-abuse EdgeButton EdgeButton--secondary">Es abusivo</button>
</div>
</div>
  ...
  <div class="DMNotice-actions u-emptyHide">    <button type="button" class="DMResendMessage-cancel EdgeButton EdgeButton--tertiary">Descartar</button>
    <button type="button" class="DMResendMessage-copy EdgeButton EdgeButton--secondary">Copiar texto del mensaje</button>
    <button type="button" class="DMResendMessage-confirm js-initial-focus EdgeButton EdgeButton--secondary">Reintentar</button>
</div>
    <button type="button" class="DMNotice-dismiss">
      <span class="Icon Icon--close"></span>
      <span class="u-hiddenVisually">Descartar</span>
    ...
    <div class="DMActivity-body js-ariaBody DMConversation-container">
      ...
      <ol class="DMConversation-content dm-convo js-dm-conversation" data-thread-id="112817801-301028364">
</ol>
  ...
  <div class="TypingIndicatorMessageBubble-dotContainer">
    ...
    <div class="DMActivity-footer u-emptyHide">    <div class="DMConversation-sendingStateIndicator u-bgUserColorLightest u-textUserColorLight" style="display: none"><div class="DMSendingStateIndicator">
...
<div class="RichEditor RichEditor--emojiPicker is-fakeFocus">
  ...
  <div class="image-selector">
    ...
    <label class="t1-label">
      ...
      <input type="file" name="media_empty" accept="image/gif,image/jpeg,image/jpg,image/png,video/mp4,video/x-m4v" multiple="" class="file-input js-tooltip" data-original-title="Añadir foto o video" data-delay="150">
    </label>
  </div>
</div>
...
<div style="position: absolute; visibility: hidden;"><div><br></div></div></form>
    ...
    <div class="DMConversation-readonly">
      <div class="DMConversation-readOnlyFooter">
        Ya no puedes enviar mensajes a esta persona. <a href="https://support.twitter.com/articles/14606#faq" target="_blank" class="learn-more" rel="noopener">Más información</a>
      </div>
    </div>
  ...
  <div class="DMActivity-container">
    ...
    <div class="DMActivity-body js-ariaBody DMAddParticipants-container js-initial-focus">
        ...
        <ul class="TokenizedMultiselect-inputContainer">
            <li>
            <textarea class="TokenizedMultiselect-input twttr-directmessage-input js-initial-focus dm-to-input" aria-autocomplete="list" aria-expanded="true" rows="1" type="text" placeholder="Ingresa un nombre" aria-owns="TokenizedMultiselectOwns7574721740"></textarea>
            </li>
        </ul>
        <ul id="DMComposeTypeaheadSuggestions" class="DMTypeaheadSuggestions u-scrollY" role="listbox"></ul>
        </div>
    ...
    <div class="DMActivity-footer u-emptyHide">   
        <div class="DMButtonBar">
            <button type="button" class="EdgeButton EdgeButton--primary DMAddParticipants-done">Listo</button>
         </div>
    </div>
  </div>
</div>
...
<div class="DMPopover DMPopover--center">
  ...
  <div class="DMPopover-content Caret Caret--top Caret--stroked ">
    ...
    <div class="DMConversationSettings-name">
      <div class="DMUpdateName u-textTruncate is-richHeader">
  <div class="DMUpdateName-header account-group">
    <span class="DMUpdateName-name u-textTruncate">!</span><span class="UserBadges"><span class="Icon Icon--verified js-verified hidden"><span class="u-hiddenVisually">Cuenta verificada</span></span><span class="Icon Icon--protected js-protected"><span class="u-hiddenVisually">Tweets Protegidos</span></span></span>
  </div>
  <div class="DMUpdateName-screenName u-textTruncate">@belenperez95</div>
  <div class="DMUpdateName-controls u-hidden">
    <span class="DMUpdateName-spinner DMSpinner u-hidden"></span>
    <div class="DMUpdateName-form input-group u-hidden">
      <input type="text" class="DMUpdateName-input" aria-label="Editar el nombre del grupo">
  ...
  <div class="js-last-tabstop" tabindex="0"></div></div>
    ...
    <!-- fin mensajes-->
            ...
            <style>@keyframes TwitterVideoPlayerBufferingAnimation { 0% { transform: rotate(0deg); } 100% { transform: rotate(360deg); } }</style>
        </div>
    </div>
</body>
@endsection